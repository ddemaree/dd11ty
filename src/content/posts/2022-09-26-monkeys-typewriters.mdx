...
tags:
  ...
  - Culture
  - Writing
featuredImage: midjourney-skeleton-writing.png
---
...
<Tweet url="https://twitter.com/ddemaree/status/1573846119527972865" />
...
<figure>
  <Image src={import("../images/midjourney-1.png")} alt="David S. Pumpkins portrait in the style of Rembrandt" />
  <figcaption>"David S. Pumpkins portrait in the style of Rembrandt"</figcaption>
</figure>

<figure class="wp-block-image size-large">
  <Image src={import("../images/midjourney-2.png")} alt="Tom Hanks as David S Pumpkins" />
...
<figure class="wp-block-image size-large">
  <Image src={import("../images/davinci-screenshot.png")} width={800} aspectRatio={1.67} alt="Screenshot of OpenAI DaVinci text completion" />
</figure>
...
<figure class="wp-block-image">
  <Image src={import("../images/midjourney-cyberpunk-mountains.png")} alt="hyperrealistic cyberpunk mountains, green sky" width={800} aspectRatio={(1400/777)} />
  <figcaption>“hyperrealistic cyberpunk mountains, green sky, lightning, flying insects, unreal engine, high contrast, 8K” — generated by me using <a href="https://midjourney.com/" target="_blank">Midjourney</a></figcaption>
</figure>

<figure class="wp-block-image">
  <Image src={import("../images/midjourney-spooky-bunnies.png")} width={512} aspectRatio={1} alt="one hundred rabbits sitting in a circle around a giant carrot embedded in the ground at nightfall" />
  <figcaption>“one hundred rabbits sitting in a circle around a giant carrot embedded in the ground at nightfall, unreal engine 5, 4K, realistic” — generated by me using&nbsp;<a href="https://midjourney.com/" target="_blank">Midjourney</a></figcaption>
</figure>
