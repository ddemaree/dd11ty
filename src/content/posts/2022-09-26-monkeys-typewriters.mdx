...
<figure class="wp-block-image size-large">
  <Image src="img/davinci-screenshot.png" width={800} aspectRatio={1.67} alt="Screenshot of OpenAI DaVinci text completion" />
</figure>
...
<figure class="wp-block-image">
  <Image src="/img/midjourney-cyberpunk-mountains.png" alt="hyperrealistic cyberpunk mountains, green sky" width={800} aspectRatio={(1400/777)} />
...
<figure class="wp-block-image">
  <Image src="/img/midjourney-spooky-bunnies.png" width={512} aspectRatio={1} alt="one hundred rabbits sitting in a circle around a giant carrot embedded in the ground at nightfall" />
