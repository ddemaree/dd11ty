...
tags:
  - Typography
  - Web Development
featuredImage: 'https://res.cloudinary.com/demaree/images/f_auto,q_auto/v1615856416/bitsandletters-assets/cover-why-fonts-matter/cover-why-fonts-matter.jpg?_i=AA'
---
<figure class="wp-block-image alignfull size-large"><img width="1600" height="1068" src="https://res.cloudinary.com/demaree/image/upload/h_1068,w_1600/v1/bitsandletters-assets/cover-why-fonts-matter.jpg" alt="" data-public-id="bitsandletters-assets/cover-why-fonts-matter.jpg" data-format="jpg" data-version="1615856416" data-size="2000 1335" data-delivery="upload" data-aspect-ratio="1.4981273408239701" loading="lazy"></figure>
...
<figure class="wp-block-image size-large"><img width="1600" height="1131" src="https://res.cloudinary.com/demaree/image/upload/h_1131,w_1600/v1/bitsandletters-assets/screenshot-do-panel.png" alt="" data-public-id="bitsandletters-assets/screenshot-do-panel.png" data-format="png" data-version="1615856415" data-size="2536 1794" data-delivery="upload" data-aspect-ratio="1.4136008918617615" loading="lazy"><figcaption>DigitalOcean’s control panel makes it easy to set up and configure Spaces, including custom domains, SSL, and CORS rules</figcaption></figure>

I keep all my fonts in the same directory of the same Spaces bucket, which I manage using Transmit:

<figure class="wp-block-image size-large is-resized"><img width="610" height="430" src="https://res.cloudinary.com/demaree/image/upload/h_430,w_610/v1/bitsandletters-assets/screenshot-transmit-webfonts.png" alt="" data-public-id="bitsandletters-assets/screenshot-transmit-webfonts.png" data-format="png" data-version="1615856415" data-size="1400 989" data-delivery="upload" data-aspect-ratio="1.4186046511627908" loading="lazy"><figcaption>My web fonts in their directory on my Spaces-powered CDN</figcaption></figure>
...
<figure class="wp-block-image size-large"><img width="1600" height="1290" src="https://res.cloudinary.com/demaree/image/upload/h_1290,w_1600/v1/bitsandletters-assets/screenshot-webfont-code-nova.png" alt="" data-public-id="bitsandletters-assets/screenshot-webfont-code-nova.png" data-format="png" data-version="1615856414" data-size="2438 1966" data-delivery="upload" data-aspect-ratio="1.2400813835198372" loading="lazy"><figcaption>CDN-hosted web fonts, integrated into my site's Hugo templates</figcaption></figure>
